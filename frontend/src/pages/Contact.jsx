...
const Contact = () => {
  ...
  return (
    <main>
      <section className="bg-black py-20 text-white"><div className="container-pad"><h1 className="text-4xl font-black sm:text-5xl">Contact {settings.companyName}</h1><p className="mt-4 max-w-2xl text-zinc-300">Tell us about your construction requirement.</p></div></section>
      <section className="py-20">
        <div className="container-pad grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
          <div><SectionTitle eyebrow="Get Estimate" title={settings.contactHeading} text={settings.contactDescription} /><div className="grid gap-4 text-sm text-zinc-700"><b>{settings.phone}</b><b>{settings.email}</b><b>{settings.address}</b><b>{settings.workingHours}</b></div></div>
